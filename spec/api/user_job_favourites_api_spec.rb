...
# Unit tests for ChronoSheetsAPI::UserJobFavouritesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserJobFavouritesApi' do
  before do
    # run before each test
    @instance = ChronoSheetsAPI::UserJobFavouritesApi.new
  end
  ...
  describe 'test an instance of UserJobFavouritesApi' do
    it 'should create an instance of UserJobFavouritesApi' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::UserJobFavouritesApi)
    end
  end
