...
# Unit tests for SwaggerClient::AggregateClientProjectsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AggregateClientProjectsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AggregateClientProjectsApi.new
  end
  ...
  describe 'test an instance of AggregateClientProjectsApi' do
    it 'should create an instance of AggregateClientProjectsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AggregateClientProjectsApi)
    end
  end
