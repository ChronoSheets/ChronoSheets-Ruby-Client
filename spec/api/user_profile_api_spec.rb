...
# Unit tests for ChronoSheetsAPI::UserProfileApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserProfileApi' do
  before do
    # run before each test
    @instance = ChronoSheetsAPI::UserProfileApi.new
  end
  ...
  describe 'test an instance of UserProfileApi' do
    it 'should create an instance of UserProfileApi' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::UserProfileApi)
    end
  end
