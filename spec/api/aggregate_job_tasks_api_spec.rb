...
# Unit tests for ChronoSheetsAPI::AggregateJobTasksApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AggregateJobTasksApi' do
  before do
    # run before each test
    @instance = ChronoSheetsAPI::AggregateJobTasksApi.new
  end
  ...
  describe 'test an instance of AggregateJobTasksApi' do
    it 'should create an instance of AggregateJobTasksApi' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::AggregateJobTasksApi)
    end
  end
