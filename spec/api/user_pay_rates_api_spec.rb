...
# Unit tests for ChronoSheetsAPI::UserPayRatesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserPayRatesApi' do
  before do
    # run before each test
    @instance = ChronoSheetsAPI::UserPayRatesApi.new
  end
  ...
  describe 'test an instance of UserPayRatesApi' do
    it 'should create an instance of UserPayRatesApi' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::UserPayRatesApi)
    end
  end
