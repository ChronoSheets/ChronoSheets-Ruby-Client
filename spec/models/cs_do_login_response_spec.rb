...
# Unit tests for ChronoSheetsAPI::CSDoLoginResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CSDoLoginResponse' do
  before do
    # run before each test
    @instance = ChronoSheetsAPI::CSDoLoginResponse.new
  end
  ...
  describe 'test an instance of CSDoLoginResponse' do
    it 'should create an instance of CSDoLoginResponse' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::CSDoLoginResponse)
    end
  end
