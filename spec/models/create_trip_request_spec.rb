...
# Unit tests for ChronoSheetsAPI::CreateTripRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateTripRequest' do
  before do
  ...
  describe 'test an instance of CreateTripRequest' do
    it 'should create an instance of CreateTripRequest' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::CreateTripRequest)
    end
  end
