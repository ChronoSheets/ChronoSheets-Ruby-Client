...
# Unit tests for ChronoSheetsAPI::AggregateProject
...
describe 'AggregateProject' do
  ...
  describe 'test an instance of AggregateProject' do
    it 'should create an instance of AggregateProject' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::AggregateProject)
    end
  end
