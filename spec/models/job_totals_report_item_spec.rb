...
# Unit tests for ChronoSheetsAPI::JobTotalsReportItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'JobTotalsReportItem' do
  before do
  ...
  describe 'test an instance of JobTotalsReportItem' do
    it 'should create an instance of JobTotalsReportItem' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::JobTotalsReportItem)
    end
  end
