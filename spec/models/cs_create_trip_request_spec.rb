...
# Unit tests for SwaggerClient::CSCreateTripRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CSCreateTripRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::CSCreateTripRequest.new
  end
  ...
  describe 'test an instance of CSCreateTripRequest' do
    it 'should create an instance of CSCreateTripRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::CSCreateTripRequest)
    end
  end
