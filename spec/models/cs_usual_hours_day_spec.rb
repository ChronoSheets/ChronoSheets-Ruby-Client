...
# Unit tests for ChronoSheetsAPI::CSUsualHoursDay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CSUsualHoursDay' do
  before do
    # run before each test
    @instance = ChronoSheetsAPI::CSUsualHoursDay.new
  end
  ...
  describe 'test an instance of CSUsualHoursDay' do
    it 'should create an instance of CSUsualHoursDay' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::CSUsualHoursDay)
    end
  end
