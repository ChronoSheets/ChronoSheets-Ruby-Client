...
# Unit tests for ChronoSheetsAPI::ClientSideUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ClientSideUser' do
  before do
  ...
  describe 'test an instance of ClientSideUser' do
    it 'should create an instance of ClientSideUser' do
      expect(@instance).to be_instance_of(ChronoSheetsAPI::ClientSideUser)
    end
  end
