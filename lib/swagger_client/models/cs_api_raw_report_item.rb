...
module SwaggerClient
  ...
  class CsApiRawReportItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PayOvertimeAmount')
        self.pay_overtime_amount = attributes[:'PayOvertimeAmount']
      end

      if attributes.has_key?(:'TripCost')
        self.trip_cost = attributes[:'TripCost']
      end

      if attributes.has_key?(:'TripDistanceMeters')
        self.trip_distance_meters = attributes[:'TripDistanceMeters']
      end
    ...
    def hash
      [organisation_id, user_id, username, email_address, job_code, task_name, client_name, project_name, start_date, end_date, span_seconds, description, pay_amount, pay_overtime_amount, trip_cost, trip_distance_meters].hash
    end
