...
module SwaggerClient
  ...
  class CsApiUpdateMyProfileRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ConfirmNewPassword')
        self.confirm_new_password = attributes[:'ConfirmNewPassword']
      end
      ...
      if attributes.has_key?(:'WantsToChangePassword')
        self.wants_to_change_password = attributes[:'WantsToChangePassword']
      end
