  ...
  class FileAttachmentsApi
    ...
    def file_attachments_delete_timesheet_file_attachment_with_http_info(file_attachment_id, x_chronosheets_auth, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"FileAttachmentsApi.file_attachments_delete_timesheet_file_attachment",
    ...
    def file_attachments_get_file_attachment_by_id_with_http_info(file_attachment_id, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseTimesheetFileAttachment'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FileAttachmentsApi.file_attachments_get_file_attachment_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param start_date [Time] The Start date of the date range.  File attachments after this date will be obtained.
    # @param end_date [Time] The End date of the date range.  File attachments before this date will be obtained.
    # @param x_chronosheets_auth [String] The ChronoSheets Auth Token
    # @param [Hash] opts the optional parameters
    ...
    def file_attachments_get_my_file_attachments_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseForPaginatedListTimesheetFileAttachment'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FileAttachmentsApi.file_attachments_get_my_file_attachments",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
