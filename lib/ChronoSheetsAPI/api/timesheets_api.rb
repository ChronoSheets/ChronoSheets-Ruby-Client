  ...
  class TimesheetsApi
    ...
    def timesheets_create_single_timesheet_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TimesheetsApi.timesheets_create_single_timesheet",
    ...
    def timesheets_delete_timesheet_with_http_info(timesheet_id, x_chronosheets_auth, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TimesheetsApi.timesheets_delete_timesheet",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param start_date [Time] The start date of the date range
    # @param end_date [Time] The end date of the date range
    # @param x_chronosheets_auth [String] The ChronoSheets Auth Token
    # @param [Hash] opts the optional parameters
    ...
    def timesheets_get_timesheets_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListTimesheet'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TimesheetsApi.timesheets_get_timesheets",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def timesheets_update_timesheets_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListInt32'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TimesheetsApi.timesheets_update_timesheets",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
