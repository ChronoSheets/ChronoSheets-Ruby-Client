...
module ChronoSheetsAPI
  class TripsApi
    ...
    # @param start_date [DateTime] The Start date of the date range.  Trips after this date will be obtained.
    # @param end_date [DateTime] The End date of the date range.  Trips before this date will be obtained.
    # @param x_chronosheets_auth [String] The ChronoSheets Auth Token
    # @param [Hash] opts the optional parameters
    ...
    def trips_get_my_trips_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ApiResponseForPaginatedListTrip' 
