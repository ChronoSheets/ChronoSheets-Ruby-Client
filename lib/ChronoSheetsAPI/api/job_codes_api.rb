  ...
  class JobCodesApi
    ...
    def job_codes_create_job_code_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JobCodesApi.job_codes_create_job_code",
    ...
    def job_codes_delete_job_code_with_http_info(job_code_id, x_chronosheets_auth, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JobCodesApi.job_codes_delete_job_code",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def job_codes_get_job_code_by_id_with_http_info(job_code_id, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseJobCode'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"JobCodesApi.job_codes_get_job_code_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def job_codes_get_job_codes_with_http_info(x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListJobCode'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"JobCodesApi.job_codes_get_job_codes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def job_codes_update_job_code_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JobCodesApi.job_codes_update_job_code",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
