  ...
  class FleetApi
    ...
    def fleet_create_vehicle_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"FleetApi.fleet_create_vehicle",
    ...
    def fleet_delete_vehicle_with_http_info(vehicle_id, x_chronosheets_auth, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"FleetApi.fleet_delete_vehicle",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def fleet_get_vehicle_by_id_with_http_info(vehicle_id, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseFleetVehicle'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FleetApi.fleet_get_vehicle_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def fleet_get_vehicles_with_http_info(x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListFleetVehicle'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FleetApi.fleet_get_vehicles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def fleet_update_vehicle_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"FleetApi.fleet_update_vehicle",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
