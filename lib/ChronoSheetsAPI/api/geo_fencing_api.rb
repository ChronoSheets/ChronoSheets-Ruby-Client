...
module ChronoSheetsAPI
  class GeoFencingApi
    ...
    def geo_fencing_create_geofence_with_http_info(request, x_chronosheets_auth, opts = {})
      ...
      # resource path
      local_var_path = '/api/GeoFencing/CreateGeofence'
    ...
    def geo_fencing_delete_geofence_with_http_info(geofence_id, x_chronosheets_auth, opts = {})
      ...
      # resource path
      local_var_path = '/api/GeoFencing/DeleteGeofence'
    ...
    def geo_fencing_get_geofence_by_id_with_http_info(geofence_id, x_chronosheets_auth, opts = {})
      ...
      # resource path
      local_var_path = '/api/GeoFencing/GetGeofenceById'
    ...
    def geo_fencing_get_geofences_with_http_info(x_chronosheets_auth, opts = {})
      ...
      # resource path
      local_var_path = '/api/GeoFencing/GetGeofences'
    ...
    def geo_fencing_update_geofence_with_http_info(request, x_chronosheets_auth, opts = {})
      ...
      # resource path
      local_var_path = '/api/GeoFencing/UpdateGeofence'
