...
module ChronoSheetsAPI
  class AggregateClientProjectsApi
    ...
    def aggregate_client_projects_get_aggregate_client_projects_with_http_info(x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListAggregateClient'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AggregateClientProjectsApi.aggregate_client_projects_get_aggregate_client_projects",
