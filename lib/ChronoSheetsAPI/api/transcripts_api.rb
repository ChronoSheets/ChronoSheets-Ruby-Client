...
module ChronoSheetsAPI
  class TranscriptsApi
    ...
    def transcripts_get_my_transcript_with_http_info(file_attachment_id, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ApiResponseTranscription' 
    ...
    # @param start_date [DateTime] The Start date of the date range.  Transcripts after this date will be obtained.
    # @param end_date [DateTime] The End date of the date range.  Transcripts before this date will be obtained.
    # @param x_chronosheets_auth [String] The ChronoSheets Auth Token
    # @param [Hash] opts the optional parameters
