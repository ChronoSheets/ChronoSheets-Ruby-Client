...
module ChronoSheetsAPI
  class UsualHoursApi
    ...
    def usual_hours_get_usual_hours_with_http_info(user_id, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListUsualHoursDay'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"UsualHoursApi.usual_hours_get_usual_hours",
    ...
    def usual_hours_set_usual_hours_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UsualHoursApi.usual_hours_set_usual_hours",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
