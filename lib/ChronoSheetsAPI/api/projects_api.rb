  ...
  class ProjectsApi
    ...
    def projects_create_project_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ProjectsApi.projects_create_project",
    ...
    def projects_get_project_by_id_with_http_info(project_id, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseProject'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ProjectsApi.projects_get_project_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def projects_get_projects_for_client_with_http_info(client_id, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListProject'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ProjectsApi.projects_get_projects_for_client",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def projects_update_project_with_http_info(x_chronosheets_auth, request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ProjectsApi.projects_update_project",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
