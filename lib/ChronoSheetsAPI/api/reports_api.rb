...
module ChronoSheetsAPI
  class ReportsApi
    ...
    # @param start_date [Time] The start date for the date range.  Report data in the response is after this date
    # @param end_date [Time] The end date for the date range.  Report data in the response is before this date
    ...
    def reports_get_all_charts_data_admin_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseCombinedReportsData'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ReportsApi.reports_get_all_charts_data_admin",
    ...
    def reports_get_all_charts_data_user_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ReportsApi.reports_get_all_charts_data_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def reports_get_fleet_summary_admin_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListFleetSummaryReportItem'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ReportsApi.reports_get_fleet_summary_admin",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def reports_get_org_trip_by_id_with_http_info(trip_id, x_chronosheets_auth, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ReportsApi.reports_get_org_trip_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def reports_get_organisation_timesheet_file_attachments_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseForPaginatedListOrgReportTimesheetFileAttachment'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ReportsApi.reports_get_organisation_timesheet_file_attachments",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def reports_get_organisation_transcripts_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ReportsApi.reports_get_organisation_transcripts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def reports_get_organisation_trips_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseForPaginatedListOrgReportTrip'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ReportsApi.reports_get_organisation_trips",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def reports_get_raw_data_admin_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseForPaginatedListRawReportItem'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ReportsApi.reports_get_raw_data_admin",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def reports_project_costings_admin_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListProjectCostingReportItem'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ReportsApi.reports_project_costings_admin",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def reports_user_jobs_over_time_with_http_info(start_date, end_date, x_chronosheets_auth, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiResponseListJobSeriesReportItem'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ReportsApi.reports_user_jobs_over_time",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
