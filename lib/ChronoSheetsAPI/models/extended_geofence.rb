...
module ChronoSheetsAPI
  class ExtendedGeofence
    ...
    attr_accessor :alert_organisation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChronoSheetsAPI::ExtendedGeofence` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChronoSheetsAPI::ExtendedGeofence`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'alert_organisation')
        self.alert_organisation = attributes[:'alert_organisation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          alert_organisation == o.alert_organisation &&
    ...
    def hash
      [job_code, task_name, created_by, updated_by, alert_organisation, geo_fencing_id, org_id, created_by_user_id, last_updated_by_user_id, name, location_name, coordinates, created_at, updated_at, trigger_job_code_id, trigger_task_id, trigger_settings, alert_to_org_group_id, alert_settings, start_time_hour, start_time_minute, end_time_hour, end_time_minute].hash
    end
