...
module ChronoSheetsAPI
  class CSCreateAutomationStepRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GeofencingId')
        self.geofencing_id = attributes[:'GeofencingId']
      end

      if attributes.has_key?(:'NfcId')
        self.nfc_id = attributes[:'NfcId']
      end
      ...
      if attributes.has_key?(:'ClientTime')
        self.client_time = attributes[:'ClientTime']
      end
    end
