...
module ChronoSheetsAPI
  class UsualHoursDay
    ...
    attr_accessor :delete_usual_hours
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChronoSheetsAPI::UsualHoursDay` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChronoSheetsAPI::UsualHoursDay`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'delete_usual_hours')
        if (value = attributes[:'delete_usual_hours']).is_a?(Array)
          self.delete_usual_hours = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          delete_usual_hours == o.delete_usual_hours
    end
    ...
    def hash
      [day_type, time_slots, delete_usual_hours].hash
    end
