  ...
  class OrgReportTranscript
    ...
    def self.openapi_types
      {
        ...
        :'completed_processing' => :'Time',
        :'created' => :'Time',
        :'started_processing' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChronoSheetsAPI::OrgReportTranscript` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChronoSheetsAPI::OrgReportTranscript`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'finished_job')
        self.finished_job = attributes[:'finished_job']
      end

      if attributes.key?(:'completed_processing')
        self.completed_processing = attributes[:'completed_processing']
      end
      ...
      if attributes.key?(:'started_processing')
        self.started_processing = attributes[:'started_processing']
      end
      ...
      if attributes.key?(:'transcription_status')
        self.transcription_status = attributes[:'transcription_status']
      end
