...
module ChronoSheetsAPI
  class CSRawReportItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SpanSecondsNormalTime')
        self.span_seconds_normal_time = attributes[:'SpanSecondsNormalTime']
      end

      if attributes.has_key?(:'SpanSecondsOvertime')
        self.span_seconds_overtime = attributes[:'SpanSecondsOvertime']
      end
    end
